...
namespace Network_Check
{
    class INIOperation
    {
        ...
        {
            string file = System.AppDomain.CurrentDomain.BaseDirectory + "IpSetting.ini";
            return file;
        }
        public static string IniFilePath(string FileName)
        {
            string file = System.AppDomain.CurrentDomain.BaseDirectory + FileName;
            return file;
        }
        #region INI文件操作  
